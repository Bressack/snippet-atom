...
Installation :
    ...
    dans atom, cliquer sur "Atom" dans la bare de menu, et selectionner "Snippets...",
    ajouter les snippet en les collant a la suite des votre, ou a la suite du bloc commentaire si vous n'en avez pas.
    
    Snippet valide pour fichier .c, .h, .cpp
